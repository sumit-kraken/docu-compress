...
class OrchestrationEngine:
    ...
    def run_pipeline_sync(self, progress_callback: Optional[Callable[[str, str], None]] = None) -> Dict[str, Any]:
        ...
        temp_dir = None
        try:
            self.repo_path, temp_dir, repo_name = resolve_repo_path(self.raw_repo_path)

            # Step 1: Explorer Agent
            log("Explorer Agent", f"Scanning repository structure at '{repo_name}'...")
